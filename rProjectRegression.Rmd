...
1.將屬性資料數值化(包含性別,單身與否,抽菸與否,酗酒與否)
2.將"工作"一變數做進一步的分析=>以男女分別進行圖像化分析,根據每一個工作類別取平均人氣指數,藉此當作工作受歡迎程度的指標,區分為受歡迎的工作,與不受歡迎工作
3.將"居住城市"一變數進行整理,處理雜訊並區分為台灣各縣市以及國外
...
發現:
1.總體分析中:身高,體重,是否有寫擇偶條件,以及你的職業類別為"行銷"時,以上因素皆與人氣指數有顯著關聯
...
2.男性分析中:身高體重=>均無顯著關系
             ...
             居住地=>無影響
3.女性分析中:體重身高=>相對於男性,較有顯著的影響,而其中的效果特性,近似於總體分析中
